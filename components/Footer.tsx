...
export default function Footer() {
  return (
    <footer className="bg-black py-20 lg:py-28 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
            ...
            {/* Sections Column */}
            <div>
              <h3 className="text-white font-semibold text-base mb-4">Sections</h3>
              <ul className="space-y-3">
                <li><Link href="#process" className="text-gray-400 hover:text-white transition-colors text-sm">Process</Link></li>
                ...
                <li><Link href="#plans" className="text-gray-400 hover:text-white transition-colors text-sm">Plans</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><span className="text-gray-400 text-sm">Coming Soon</span></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">© 2024 UNICO. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
